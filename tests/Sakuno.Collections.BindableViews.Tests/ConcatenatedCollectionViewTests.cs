...
namespace Sakuno.Collections.BindableViews.Tests
{
    ...
    {
        [Fact]
        public static void SimpleCollections()
        {
            var sources = new[]
            {
                new[] { 1, 2, 3 },
        ...
        [Fact]
        public static void OuterObservableCollections_Add()
        {
        ...
        [Fact]
        public static void InnerObservableCollections_Add()
        {
        ...
        [Fact]
        public static void BothObservableCollections_Add()
        {
        ...
        [Fact]
        public static void OuterObservableCollections_Remove()
        {
            var source = new ObservableCollection<int[]>()
            {
                new[] { 1 },
        ...
        [Fact]
        public static void InnerObservableCollections_Remove()
        {
        ...
        [Fact]
        public static void BothObservableCollections_Remove()
        {
        ...
        [Fact]
        public static void OuterObservableCollections_Replace()
        {
            var source = new ObservableCollection<int[]>()
            {
                new[] { 2, 3 },
        ...
        [Fact]
        public static void InnerObservableCollections_Replace()
        {
            var a = new ObservableCollection<int>() { 1, 3, 2 };
        ...
        [Fact]
        public static void OuterObservableCollections_Clear()
        {
            var source = new ObservableCollection<int[]>()
            {
                new[] { 1 },
        ...
        [Fact]
        public static void InnerObservableCollections_Clear()
        {
